...
const EvidenceDetail = lazyPage(
  () => import("@/pages/EvidenceDetail"),
  "EvidenceDetail",
);
const Knowledge = lazyPage(() => import("@/pages/Knowledge"), "Knowledge");
const KnowledgeDetail = lazyPage(
  () => import("@/pages/KnowledgeDetail"),
  "KnowledgeDetail",
);
...
const WorkspaceDetail = lazyPage(
  () => import("@/pages/WorkspaceDetail"),
  "WorkspaceDetail",
);
const WorkspaceSettings = lazyPage(
  () => import("@/pages/WorkspaceSettings"),
  "WorkspaceSettings",
);
const Settings = lazyPage(() => import("@/pages/Settings"), "Settings");
const Search = lazyPage(() => import("@/pages/Search"), "Search");
const Publications = lazyPage(
  () => import("@/pages/Publications"),
  "Publications",
);
const PublicationDetail = lazyPage(
  () => import("@/pages/PublicationDetail"),
  "PublicationDetail",
);
...
function ProjectsRedirect() {
  ...
  queueMicrotask(() =>
    navigate(id ? `/workspaces/${id}` : "/workspaces", { replace: true }),
  );
  return null;
}
